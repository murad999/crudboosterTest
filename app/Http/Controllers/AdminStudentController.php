<?php namespace App\Http\Controllers;
	...
	class AdminStudentController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Id","id"=>"id","join"=>"student_teachers,student_id"];
			$this->col[] = ["label"=>"Name","name"=>"name"];
			//$this->col[] = ["label"=>"Teachers","name"=>"id","join"=>"student_teachers,teachers_id"];
			...
			$this->form[] = ['label'=>'Teachers','name'=>'teachers_id','type'=>'select2','validation'=>'required','width'=>'col-sm-10','datatable'=>'teachers,name','relationship_table'=>'student_teachers'];
